...
namespace OpenDashPlugin
{
    public static class FacePages
    {
        ...
        /// draw other cars out of a list, and all three are in the module catalogue. Zone A lists
        /// nobody. Band D's own relative page is three gaps rather than a list, so filtering it would
        /// mean asking for the car ahead in class rather than listing fewer of them -- the same idea,
