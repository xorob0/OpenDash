...
|---|---|---|
| Oil too hot | `OpenDash.FlagBoxMatrix<N>OilTemp`, default 120 °C | A disc, orange, blinking |
| Water too hot | `OpenDash.FlagBoxMatrix<N>WaterTemp`, default 110 °C | Waves, orange, blinking |
