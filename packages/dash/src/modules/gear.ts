...
/** The gear fills the page: as tall as the box allows, up to the face's own 260. */
export const gearSizeFor = (height: number): number => Math.max(72, Math.min(260, Math.floor(height * 0.86)));
