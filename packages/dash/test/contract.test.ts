...
describe('settings', () => {
  test('declares the dash, the zones, the companion and the pit wall', () => {
    ...
    // the same reason: ADR 0003, and ADR 0013 for why they are here at all. The flag box is five
    ...
    expect(flagBoxProperties()).toHaveLength(5 + FLAG_BOX_MATRICES.length * 10);
