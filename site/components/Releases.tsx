 ...
 * release. `lib/markdown.ts` parses the narrow subset the file uses into spans; turning those into
 * elements is this file's job, which is why no part of the site needs `dangerouslySetInnerHTML`.
 */
        ...
        <article key={release.version} className={styles.release} id={`v${release.version}`}>
          <header className={styles.head}>
            ...
            <div className={styles.meta}>
              ...
              {release.unreleased ? <span>On main, untagged</span> : null}
              {release.preRelease && !release.unreleased ? <span className={styles.pre}>Pre-release</span> : null}
            </div>
          </header>
